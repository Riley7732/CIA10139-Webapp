...
<head>
	...
	<style>
		...
		#insert_btn:hover, #cancel_btn:hover {
    ...
    <div class="G3_content">
    	...
    	<div id="activity">
	    	...
	    	<table>
	    		<tr>
					...
					<td>
						<select name="activityCategoryID">
						    ...
						    %>
						        <option value="<%= activityCategory.getActivityCategoryID() %>"><%= activityCategory.getActivityCategoryName() %></option>
						    <% 
						    }
						    %>
						</select>
				...
				<tr>
					<td>活動名稱：</td>
					<td><input type="text" name="activityName" value="<%=(activity == null) ? "請輸入活動名稱" : activity.getActivityName() %>"/></td>
				</tr>
				<tr>
					<td>活動價格：</td>
					<td><input type="text" name="activityPrice" value="<%=(activity == null) ? "請輸入活動價格" : activity.getActivityPrice() %>"/></td>
				</tr>
				<tr>
					<td>活動資訊：</td>
					<td><textarea name="activityInfo"><%=(activity == null) ? "請輸入活動資訊" : activity.getActivityInfo() %></textarea></td>
				</tr>
				<tr>
					<td>活動注意事項：</td>
					<td><textarea name="activityNotice"><%=(activity == null) ? "請輸入注意事項" : activity.getActivityNotice() %></textarea></td>
				</tr>
				<tr>
					<td>活動狀態：</td>
					<td>
			...
			<div id="set">
				<div id="button-container">
					<input type="submit" value="新增" id="insert_btn">
